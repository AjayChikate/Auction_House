  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4">
      ...
      <p className="text-gray-300 mb-8 text-lg">
        Need help? We're here for you! If you have any questions about auctions, payments, or your account, check the
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-xl shadow-lg p-6 mb-8">
        ...
        <ul className="space-y-3 text-gray-300">
          ...
          <li>
            ...
            <br /> A: Log in, go to the Lobby, click Create Room, and fill in the details.
          </li>
          <li>
          ...
          <li>
            ...
            <br /> A: The highest bidder wins. A bounded history of bids and chat messages is kept for that room.
          </li>
          <li>
            <span className="font-semibold text-cyan-400">
              Q: Why is the auction room creator allowed to bid?
            </span>
            <br /> A: This acts as a reserve-price mechanism, letting the creator ensure the item isn't sold for
            less than they personally value it at.
          </li>
        </ul>
      </div>
      <div className="bg-gray-800 border border-gray-700 rounded-xl shadow-lg p-6">
        <h2 className="text-xl font-semibold text-white mb-4">Contact Us</h2>
        <p className="text-gray-300 mb-4">Still need help? Contact our support team directly.</p>
        <div className="space-y-2">
          <p className="flex items-center gap-2">
            <FaEnvelope className="text-cyan-400" /> xyz@support.....
          </p>
          <p className="flex items-center gap-2">
            <FaPhoneAlt className="text-cyan-400" /> +91-00000-00000
          </p>
        </div>
      </div>
    </div>
